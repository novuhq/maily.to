...
var SuggestionInput = (0, import_react29.forwardRef)((props, ref) => {
  var _b;
  const _a = props, {
    value = "",
    onValueChange,
...
var NumberInput = (0, import_react37.forwardRef)(
  (props, ref) => {
...
function RepeatBubbleMenu(props) {
  ...
  const bubbleMenuProps = __spreadProps(__spreadValues(__spreadValues({}, props), appendTo ? { appendTo: appendTo.current } : {}), {
    shouldShow: ({ editor: editor2 }) => {
      ...
      const sectionNodeChildren = activeForNode ? (_a = (0, import_react39.findChildren)(activeForNode == null ? void 0 : activeForNode.node, (node) => {
  ...
  const [isUpdatingKey, setIsUpdatingKey] = (0, import_react40.useState)(false);
  const eachKey = (state == null ? void 0 : state.each) || "";
  const autoCompleteOptions = (0, import_react40.useMemo)(() => {
    return processVariables(variables, {
      query: eachKey || "",
      editor,
...
function SectionBubbleMenu(props) {
  ...
  const getReferenceClientRect = (0, import_react43.useCallback)(() => {
  ...
  const bubbleMenuProps = __spreadProps(__spreadValues(__spreadValues({}, props), appendTo ? { appendTo: appendTo.current } : {}), {
    shouldShow: ({ editor: editor2 }) => {
      ...
      const repeatNodeChildren = activeSectionNode ? (_a = (0, import_react42.findChildren)(activeSectionNode == null ? void 0 : activeSectionNode.node, (node) => {
        return node.type.name === "repeat";
      })) == null ? void 0 : _a[0] : null;
      const inlineImageNodeChildren = activeSectionNode ? (_b = (0, import_react42.findChildren)(activeSectionNode == null ? void 0 : activeSectionNode.node, (node) => {
...
var useSpacerState = (editor) => {
  const states = (0, import_react44.useEditorState)({
    editor,
    selector: (ctx) => {
      var _a;
      return {
...
var LinkCardExtension = import_core13.Node.create({
  ...
  addNodeView() {
    return (0, import_react48.ReactNodeViewRenderer)(LinkCardComponent, {
      className: "mly-relative"
    });
  }
});
...
function ButtonLabelInput(props) {
  ...
  const linkInputRef = (0, import_react49.useRef)(null);
  const [isEditing, setIsEditing] = (0, import_react49.useState)(!isVariable);
  const { placeholderUrl = DEFAULT_PLACEHOLDER_URL } = useMailyContext();
  const providers = useSuggestionProviders(editor, enabledProviders);
...
function ButtonView(props) {
  ...
  const sizes = (0, import_react51.useMemo)(
    () => ({
      small: {
        paddingX: 24,
        paddingY: 6
  ...
  const size = (0, import_react51.useMemo)(() => {
    var _a;
...
var ButtonExtension = import_core14.Node.create({
  ...
  addNodeView() {
    return (0, import_react52.ReactNodeViewRenderer)(ButtonView, {
...
var ImageExtension = import_extension_image2.default.extend({
  ...
  addNodeView() {
    return (0, import_react53.ReactNodeViewRenderer)(ImageView, {
      className: "mly-relative"
    });
  }
});
...
function HTMLCodeBlockView(props) {
  ...
  const html2 = (0, import_react55.useMemo)(() => {
    ...
    import_react54.NodeViewWrapper,
    {
      ...
      children: [
        activeTab === "code" && /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("pre", { className: "mly-my-0 mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-p-2 mly-text-black", children: /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
          import_react54.NodeViewContent,
          {
            as: "code",
...
var DefaultInlineDecoratorComponent = ({ decoratorKey, onUpdate, onDelete }) => {
  const [isEditing, setIsEditing] = import_react56.default.useState(false);
  const [editValue, setEditValue] = import_react56.default.useState(decoratorKey);
  ...
  try {
    ...
    return {
      ...
      renderValue: (value, editor2, from) => {
        ...
        return import_react57.default.createElement(DecoratorComponent, __spreadValues({
...
function updateDecoratorText(editor, from, to, newKey, options) {
  const { state, dispatch } = editor.view;
  const { tr } = state;
...
function createDecoratorWidget(editor, from, to, key, options) {
  const renderer = new import_react58.ReactRenderer(options.decoratorComponent, {
    props: {
      decoratorKey: key,
      onUpdate: (newKey) => updateDecoratorText(editor, from, to, newKey, options),
...
var InlineDecoratorList = (0, import_react60.forwardRef)(
  (props, ref) => {
    var _a;
    ...
    const transformedItems = (0, import_react60.useMemo)(
      () => transformItemsForPopover(items),
      [items]
    );
    const handleKeyDown = (0, import_react60.useMemo)(() => createKeyboardHandler(popoverRef), []);
    const handleItemSelect = (0, import_react60.useMemo)(
...
function RepeatView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime56.jsxs)(
    import_react61.NodeViewWrapper,
    {
      "data-type": "repeat",
      draggable: editor.isEditable,
      "data-drag-handle": editor.isEditable,
      className: "mly-relative",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime56.jsx)(import_react61.NodeViewContent, { className: "is-editable" }),
...
var RepeatExtension = import_core17.Node.create({
  ...
  addNodeView() {
    return (0, import_react62.ReactNodeViewRenderer)(RepeatView, {
      contentDOMElementTag: "div",
      className: "mly-relative"
    });
  }
...
function SlashCommandItem(props) {
  ...
  const checkVisibility = (0, import_react63.useCallback)(() => {
  ...
  const openTimerRef = (0, import_react63.useRef)(0);
  const handleDelayedOpen = (0, import_react63.useCallback)(() => {
...
var CommandList = (0, import_react65.forwardRef)(function CommandList2(props, ref) {
  const { items: groups, command, editor, range, query } = props;
  const [selectedGroupIndex, setSelectedGroupIndex] = (0, import_react65.useState)(0);
  const [selectedCommandIndex, setSelectedCommandIndex] = (0, import_react65.useState)(0);
  const [hoveredItemKey, setHoveredItemKey] = (0, import_react65.useState)(null);
  const prevQuery = (0, import_react65.useRef)("");
  const prevSelectedGroupIndex = (0, import_react65.useRef)(0);
  const prevSelectedCommandIndex = (0, import_react65.useRef)(0);
  ...
  const commandListContainer = (0, import_react65.useRef)(null);
  const activeCommandRef = (0, import_react65.useRef)(null);
  ...
  return groups.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime58.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime58.jsxs)("div", { className: "mly-z-50 mly-w-72 mly-overflow-hidden mly-rounded-md mly-border mly-border-gray-200 mly-bg-white mly-shadow-md mly-transition-all", children: [
    /* @__PURE__ */ (0, import_jsx_runtime58.jsx)(
      "div",
      {
        ...
        children: groups.map((group, groupIndex) => /* @__PURE__ */ (0, import_jsx_runtime58.jsxs)(import_react65.Fragment, { children: [
...
function getSlashCommandSuggestions(groups = DEFAULT_SLASH_COMMANDS) {
  return {
    ...
    render: () => {
      ...
      return {
        onStart: (props) => {
          component = new import_react64.ReactRenderer(CommandList, {
            props,
            editor: props.editor
          });
...
var VariableList = (0, import_react67.forwardRef)((props, ref) => {
  var _a;
...
function getVariableSuggestions(char = DEFAULT_VARIABLE_TRIGGER_CHAR) {
  return {
    ...
    render: () => {
      ...
      return {
        onStart: (props) => {
          component = new import_react66.ReactRenderer(VariableList, {
            props,
            editor: props.editor
          });
          if (!props.clientRect) {
...
var HTMLCodeBlockExtension = import_extension_code_block_lowlight.default.extend({
  ...
  addNodeView() {
    return (0, import_react68.ReactNodeViewRenderer)(HTMLCodeBlockView, {
      className: "mly-relative",
      attrs: ({ node }) => {
        var _a;
        return {
...
var useTextMenuState = (editor) => {
  const states = (0, import_react69.useEditorState)({
    editor,
    selector: (ctx) => {
      var _a, _b, _c, _d, _e, _f, _g, _h;
      return {
...
function TurnIntoBlock(props) {
  const { options } = props;
  const activeItem = (0, import_react70.useMemo)(
...
function useTurnIntoBlockOptions(editor) {
  return (0, import_react71.useEditorState)({
    editor,
    selector: ({ editor: editor2 }) => [
      {
        type: "category",
...
function Editor13(props) {
  ...
  const formattedContent = (0, import_react75.useMemo)(() => {
    if (contentJson) {
  ...
  const menuContainerRef = (0, import_react75.useRef)(null);
  const editor = (0, import_react74.useEditor)({
    editorProps: {
      attributes: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime64.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime64.jsx)(import_react74.EditorContent, { editor }),
