...
import { useMemo as useMemo15, useRef as useRef15 } from "react";
...
var ColumnExtension = Node.create({
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes(HTMLAttributes3, {
        "data-type": "column",
...
import { forwardRef as forwardRef4, useRef, useCallback as useCallback2 } from "react";
...
var InputAutocomplete = forwardRef4((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: cn("mly-relative"), ref: containerRef, children: [
    ...
    isTriggeringVariable && VariableSuggestionPopoverComponent && /* @__PURE__ */ jsx7("div", { className: "mly-absolute mly-left-0 mly-top-8", children: /* @__PURE__ */ jsx7(
...
function ColumnsBubbleMenu(props) {
  ...
  const getReferenceClientRect = useCallback3(() => {
...
function HTMLBubbleMenu(props) {
  ...
  const getReferenceClientRect = useCallback5(() => {
...
import { useCallback as useCallback6, useLayoutEffect, useRef as useRef4 } from "react";
...
function ImageView(props) {
  ...
  const dragCornerButton = useCallback7(
    (direction) => {
...
function LogoView(props) {
  ...
  const handleImageUpload = useCallback8(
    (file) => __async(null, null, function* () {
      if (!isDroppable) {
        return;
      }
...
var SuggestionInput = forwardRef6((props, ref) => {
  const _a = props, {
    value = "",
    onValueChange,
    onSelectSuggestion,
  ...
  const VariableSuggestionPopoverComponent = useMemo7(() => {
    if (!activeSuggestion) {
  ...
  const handleOutsideClick = useCallback9(() => {
    onOutsideClick == null ? void 0 : onOutsideClick();
  }, [onOutsideClick]);
  useOutsideClick(containerRef, handleOutsideClick);
  useEffect7(() => {
  ...
  return /* @__PURE__ */ jsxs17("div", { className: cn("mly-relative"), ref: containerRef, children: [
    /* @__PURE__ */ jsxs17("label", { className: "mly-relative", children: [
      ...
      /* @__PURE__ */ jsx35("div", { className: "mly-absolute mly-inset-y-0 mly-right-1 mly-flex mly-items-center", children: /* @__PURE__ */ jsx35(CornerDownLeft2, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) })
    ] }),
    isTriggering && VariableSuggestionPopoverComponent && /* @__PURE__ */ jsx35("div", { className: "mly-absolute mly-left-0 mly-top-8", children: /* @__PURE__ */ jsx35(
      VariableSuggestionPopoverComponent,
      {
    ...
    isLoading && /* @__PURE__ */ jsx35("div", { className: "mly-absolute mly-left-0 mly-top-8 mly-rounded-md mly-bg-white mly-p-2 mly-shadow-md", children: "Loading suggestions..." })
  ] });
});
...
var VariableExtension = Node4.create({
  ...
  renderHTML({ node, HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes3({ "data-type": this.name }, HTMLAttributes3),
...
function LinkInputPopover(props) {
  ...
  const [isEditing, setIsEditing] = useState8(!isVariable);
  ...
  const popoverButton = /* @__PURE__ */ jsx36(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx36(
    BaseButton,
    {
      variant: "ghost",
      size: "sm",
      ...
      children: /* @__PURE__ */ jsx36(Icon, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5] mly-text-midnight-gray" })
    }
  ) });
    ...
    Popover,
    {
      ...
      children: [
        tooltip ? /* @__PURE__ */ jsxs18(Tooltip, { children: [
          /* @__PURE__ */ jsx36(TooltipTrigger, { asChild: true, children: popoverButton }),
          /* @__PURE__ */ jsx36(TooltipContent, { sideOffset: 8, children: tooltip })
        ] }) : popoverButton,
        /* @__PURE__ */ jsx36(
          PopoverContent,
          {
            ...
            children: /* @__PURE__ */ jsx36(
              "form",
              {
                ...
                children: /* @__PURE__ */ jsxs18("div", { className: "mly-isolate mly-flex mly-rounded-lg", children: [
                  !isEditing && /* @__PURE__ */ jsx36("div", { className: "mly-flex mly-h-8 mly-items-center mly-rounded-lg mly-border mly-border-gray-300 mly-bg-white mly-px-0.5", children: /* @__PURE__ */ jsx36(
                    "button",
                    {
                      onClick: () => {
                        setIsEditing(true);
                  ...
                  isEditing && /* @__PURE__ */ jsxs18("div", { className: "mly-relative", children: [
                    /* @__PURE__ */ jsx36("div", { className: "mly-absolute mly-inset-y-0 mly-left-1.5 mly-z-10 mly-flex mly-items-center", children: /* @__PURE__ */ jsx36(LinkIcon2, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) }),
                    /* @__PURE__ */ jsx36(
                      InputAutocomplete,
                      {
                        editor,
...
function ImageSize(props) {
  ...
  return /* @__PURE__ */ jsxs19("label", { className: "mly-relative mly-flex mly-items-center", children: [
    /* @__PURE__ */ jsx37("span", { className: "mly-absolute mly-inset-y-0 mly-left-2 mly-flex mly-items-center mly-text-xs mly-leading-none mly-text-gray-400", children: dimension === "width" ? "W" : "H" }),
    /* @__PURE__ */ jsx37(
      "input",
      __spreadProps(__spreadValues({}, AUTOCOMPLETE_PASSWORD_MANAGERS_OFF), {
    ...
    /* @__PURE__ */ jsx37("span", { className: "mly-absolute mly-inset-y-0 mly-right-1 mly-flex mly-items-center mly-text-xs mly-leading-none mly-text-gray-400", children: "PX" })
  ] });
}
  ...
  return /* @__PURE__ */ jsx38(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      ...
      children: /* @__PURE__ */ jsxs20(TooltipProvider, { children: [
        state.isLogoActive && state.imageSrc && /* @__PURE__ */ jsxs20(Fragment4, { children: [
          /* @__PURE__ */ jsx38(
            Select,
            {
              label: "Size",
        ...
        /* @__PURE__ */ jsxs20("div", { className: "mly-flex mly-space-x-0.5", children: [
          /* @__PURE__ */ jsx38(
            AlignmentSwitch,
            {
          ...
          state.isImageActive && /* @__PURE__ */ jsx38(
            LinkInputPopover,
            {
        ...
        state.isImageActive && state.imageSrc && /* @__PURE__ */ jsxs20(Fragment4, { children: [
          /* @__PURE__ */ jsx38(Divider, {}),
          /* @__PURE__ */ jsx38(
            Select,
            {
...
var InlineImageExtension = Node5.create({
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    const attrs = mergeAttributes4(this.options.HTMLAttributes, HTMLAttributes3, {
      "data-type": this.name,
...
function InlineImageBubbleMenu(props) {
  ...
  return /* @__PURE__ */ jsx39(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      className: "mly-flex mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-p-0.5 mly-shadow-md",
      children: /* @__PURE__ */ jsx39(TooltipProvider, { children: /* @__PURE__ */ jsxs21("div", { className: "mly-flex mly-space-x-0.5", children: [
        /* @__PURE__ */ jsx39(
          LinkInputPopover,
          {
...
import {
  BubbleMenu as BubbleMenu5,
  findChildren
} from "@tiptap/react";
import { InfoIcon as InfoIcon2, Repeat2 as Repeat22 } from "lucide-react";
import { useCallback as useCallback10, useMemo as useMemo9, useRef as useRef9, useState as useState9 } from "react";
  ...
  (props, ref) => {
    ...
    const content = /* @__PURE__ */ jsxs22(
      "label",
      {
        ...
        children: [
          Icon ? /* @__PURE__ */ jsx40(Icon, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5]" }) : null,
          /* @__PURE__ */ jsx40(
            "input",
            __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, AUTOCOMPLETE_PASSWORD_MANAGERS_OFF), {
              min: 0
    ...
    if (tooltip) {
      return /* @__PURE__ */ jsxs22(Tooltip, { children: [
        /* @__PURE__ */ jsx40(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx40("span", { children: content }) }),
        /* @__PURE__ */ jsx40(TooltipContent, { sideOffset: 8, children: tooltip })
      ] });
    }
    return content;
  }
...
function RepeatBubbleMenu(props) {
  ...
  const getReferenceClientRect = useCallback10(() => {
  ...
  const [isUpdatingKey, setIsUpdatingKey] = useState9(false);
  ...
  return /* @__PURE__ */ jsx41(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      ...
      children: /* @__PURE__ */ jsxs23(TooltipProvider, { children: [
        /* @__PURE__ */ jsxs23("div", { className: "mly-flex mly-items-stretch", children: [
          /* @__PURE__ */ jsxs23("div", { className: "mly-flex mly-items-center mly-gap-1.5 mly-px-1.5 mly-text-sm mly-leading-none", children: [
            "Repeat for",
            /* @__PURE__ */ jsxs23(Tooltip, { children: [
              /* @__PURE__ */ jsx41(TooltipTrigger, { children: /* @__PURE__ */ jsx41(
                InfoIcon2,
                {
                  className: cn(
          ...
          /* @__PURE__ */ jsxs23("div", { className: "mly-flex mly-items-center mly-gap-1.5 mly-px-1.5 mly-text-sm", children: [
            !isUpdatingKey && /* @__PURE__ */ jsx41(
              "button",
              {
                onClick: () => {
                  setIsUpdatingKey(true);
          ...
          /* @__PURE__ */ jsx41(Divider, { className: "mly-bg-gray-100" }),
          /* @__PURE__ */ jsx41("div", { className: "mly-flex mly-items-center mly-gap-1.5 mly-px-1.5", children: /* @__PURE__ */ jsx41(
            NumberInput,
            {
...
function BorderColor(props) {
  ...
  return /* @__PURE__ */ jsxs24(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx42("path", { d: "M0 11H10.6667", stroke: "currentColor", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsx42(
          "path",
          {
...
function ColorPicker(props) {
  ...
  const popoverButton = /* @__PURE__ */ jsx45(PopoverTrigger, { asChild: true, children: children || /* @__PURE__ */ jsx45(
    BaseButton,
    {
      variant: "ghost",
    ...
    Popover,
    {
      ...
      children: [
        tooltip ? /* @__PURE__ */ jsxs25(Tooltip, { children: [
          /* @__PURE__ */ jsx45(TooltipTrigger, { asChild: true, children: popoverButton }),
          /* @__PURE__ */ jsx45(TooltipContent, { sideOffset: 8, children: tooltip })
        ] }) : popoverButton,
        /* @__PURE__ */ jsx45(
          PopoverContent,
          {
            ...
            sideOffset: 8,
            children: /* @__PURE__ */ jsxs25("div", { className: "mly-min-w-[260px] mly-rounded-xl mly-border mly-border-gray-200 mly-bg-white mly-p-4", children: [
              /* @__PURE__ */ jsx45(
                HexColorPicker,
                {
                  color,
              ...
              suggestedColors.length > 0 && /* @__PURE__ */ jsxs25("div", { children: [
                /* @__PURE__ */ jsx45("div", { className: "-mly-mx-4 mly-my-4 mly-h-px mly-bg-gray-200" }),
                /* @__PURE__ */ jsx45("h2", { className: "mly-text-xs mly-text-gray-500", children: "Recently used" }),
                /* @__PURE__ */ jsx45("div", { className: "mly-mt-2 mly-flex mly-flex-wrap mly-gap-0.5", children: suggestedColors.map((suggestedColor) => /* @__PURE__ */ jsx45(
                  BaseButton,
                  {
                    variant: "ghost",
                    size: "sm",
...
function SectionBubbleMenu(props) {
  ...
  const getReferenceClientRect = useCallback11(() => {
  ...
  return /* @__PURE__ */ jsx46(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      className: "mly-flex mly-items-stretch mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-p-0.5 mly-shadow-md",
      children: /* @__PURE__ */ jsxs26(TooltipProvider, { children: [
        /* @__PURE__ */ jsx46(
          AlignmentSwitch,
          {
        ...
        state.isColumnsActive && /* @__PURE__ */ jsxs26(Fragment5, { children: [
          /* @__PURE__ */ jsx46(Divider, {}),
          /* @__PURE__ */ jsxs26(Popover, { children: [
            /* @__PURE__ */ jsxs26(PopoverTrigger, { className: "mly-flex mly-items-center mly-gap-1 mly-rounded-md mly-px-1.5 mly-text-sm data-[state=open]:mly-bg-soft-gray hover:mly-bg-soft-gray", children: [
              "Column",
              /* @__PURE__ */ jsx46(ChevronUp, { className: "mly-h-3 mly-w-3" })
            ] }),
            /* @__PURE__ */ jsx46(
              PopoverContent,
              {
                ...
                children: /* @__PURE__ */ jsx46(ColumnsBubbleMenuContent, { editor })
              }
            )
          ] })
        ] })
...
function SpacerBubbleMenu(props) {
  ...
  return /* @__PURE__ */ jsx47(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      ...
      children: /* @__PURE__ */ jsxs27(TooltipProvider, { children: [
        items.map((item, index) => /* @__PURE__ */ jsx47(
          BubbleMenuButton,
          __spreadValues({
...
function LinkCardComponent(props) {
  ...
  return /* @__PURE__ */ jsx50(
    NodeViewWrapper4,
    {
      ...
      draggable: editor.isEditable,
      "data-drag-handle": editor.isEditable,
      children: /* @__PURE__ */ jsxs28(Popover, { open: props.selected, children: [
        /* @__PURE__ */ jsx50(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx50(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs28("div", { className: "mly-no-prose mly-flex mly-flex-col mly-rounded-lg mly-border mly-border-gray-300", children: [
              image2 && /* @__PURE__ */ jsx50("div", { className: "mly-relative mly-mb-1.5 mly-w-full mly-shrink-0", children: /* @__PURE__ */ jsx50(
                "img",
                {
                  src: image2,
                  alt: "link-card",
              ...
              /* @__PURE__ */ jsx50("div", { className: "mly-flex mly-items-stretch mly-p-3", children: /* @__PURE__ */ jsxs28("div", { className: cn("mly-flex mly-flex-col"), children: [
                /* @__PURE__ */ jsxs28("div", { className: "!mly-mb-1.5 mly-flex mly-items-center mly-gap-1.5", children: [
                  /* @__PURE__ */ jsx50("h2", { className: "!mly-mb-0 !mly-text-lg mly-font-semibold", children: title }),
                  badgeText && /* @__PURE__ */ jsx50("span", { className: "!mly-font-base text-xs mly-rounded-md mly-bg-yellow-200 mly-px-2 mly-py-1 mly-font-semibold mly-leading-none", children: badgeText }),
                  " ",
                  subTitle && !badgeText && /* @__PURE__ */ jsx50("span", { className: "!mly-font-base text-xs mly-font-regular mly-rounded-md mly-leading-none mly-text-gray-400", children: subTitle })
                ] }),
                /* @__PURE__ */ jsxs28("p", { className: "!mly-my-0 !mly-text-base mly-text-gray-500", children: [
                  description,
                  " ",
                  linkTitle ? /* @__PURE__ */ jsx50("a", { href: link, className: "mly-font-semibold", children: linkTitle }) : null
                ] })
              ] }) })
            ] })
          }
        ...
        /* @__PURE__ */ jsxs28(
          PopoverContent,
          {
            ...
            onCloseAutoFocus: (e) => e.preventDefault(),
            children: [
              /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Image" }),
                /* @__PURE__ */ jsx50(
                  Input,
                  {
              ...
              /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Title" }),
                /* @__PURE__ */ jsx50(
                  Input,
                  {
              ...
              /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Description" }),
                /* @__PURE__ */ jsx50(
                  Textarea,
                  {
              ...
              /* @__PURE__ */ jsxs28("div", { className: "mly-grid mly-grid-cols-2 mly-gap-2", children: [
                /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Link Title" }),
                  /* @__PURE__ */ jsx50(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Link" }),
                  /* @__PURE__ */ jsx50(
                    Input,
                    {
              ...
              /* @__PURE__ */ jsxs28("div", { className: "mly-grid mly-grid-cols-2 mly-gap-2", children: [
                /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Badge Text" }),
                  /* @__PURE__ */ jsx50(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxs28("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx50("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Sub Title" }),
                  /* @__PURE__ */ jsx50(
                    Input,
                    {
...
function ButtonLabelInput(props) {
  ...
  const linkInputRef = useRef10(null);
  const [isEditing, setIsEditing] = useState10(!isVariable);
  const { placeholderUrl = DEFAULT_PLACEHOLDER_URL } = useMailyContext();
  const providers = useSuggestionProviders(editor, enabledProviders);
  const matchingProvider = useMatchingProvider(value, providers);
  return /* @__PURE__ */ jsxs29("div", { className: "mly-isolate mly-flex mly-rounded-lg", children: [
    !isEditing && matchingProvider && /* @__PURE__ */ jsx51(
      "button",
      {
        onClick: () => {
          setIsEditing(true);
...
function ButtonView(props) {
  ...
  return /* @__PURE__ */ jsx52(
    NodeViewWrapper5,
    {
      ...
      children: /* @__PURE__ */ jsxs30(Popover, { open: props.selected && editor.isEditable, children: [
        /* @__PURE__ */ jsx52(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx52("div", { children: /* @__PURE__ */ jsx52(
          "button",
          {
            className: cn(
        ...
        /* @__PURE__ */ jsx52(
          PopoverContent,
          {
            ...
            onOpenAutoFocus: (e) => e.preventDefault(),
            onCloseAutoFocus: (e) => e.preventDefault(),
            children: /* @__PURE__ */ jsx52(TooltipProvider, { children: /* @__PURE__ */ jsxs30("div", { className: "mly-flex mly-items-stretch mly-text-midnight-gray", children: [
              /* @__PURE__ */ jsx52(
                ButtonLabelInput,
                {
                  value: text2,
              ...
              /* @__PURE__ */ jsx52(Divider, {}),
              /* @__PURE__ */ jsxs30("div", { className: "mly-flex mly-space-x-0.5", children: [
                /* @__PURE__ */ jsx52(
                  Select,
                  {
                    label: "Border Radius",
...
function TextColorPickerPopup(props) {
  ...
  return /* @__PURE__ */ jsx52(ColorPicker, { color, onColorChange: onChange, tooltip: "Text Color", children: /* @__PURE__ */ jsx52(
    BaseButton,
    {
      variant: "ghost",
      size: "sm",
      ...
      children: /* @__PURE__ */ jsxs30("div", { className: "mly-flex mly-flex-col mly-items-center mly-justify-center mly-gap-[1px]", children: [
        /* @__PURE__ */ jsx52("span", { className: "mly-font-bolder mly-font-mono mly-text-xs mly-text-midnight-gray", children: "A" }),
        /* @__PURE__ */ jsx52(
          "div",
          {
...
function HTMLCodeBlockView(props) {
  ...
  return /* @__PURE__ */ jsxs31(
    NodeViewWrapper6,
    {
      ...
      children: [
        activeTab === "code" && /* @__PURE__ */ jsx53("pre", { className: "mly-my-0 mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-p-2 mly-text-black", children: /* @__PURE__ */ jsx53(
          NodeViewContent,
          {
            as: "code",
        ...
        activeTab === "preview" && /* @__PURE__ */ jsx53(
          "div",
          {
            className: cn(
...
import { PluginKey as PluginKey5 } from "@tiptap/pm/state";
...
var DefaultInlineDecoratorComponent = ({ decoratorKey, onUpdate, onDelete }) => {
  ...
  const [editValue, setEditValue] = React7.useState(decoratorKey);
  ...
  return /* @__PURE__ */ jsxs32(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx54("span", { children: decoratorKey }),
        /* @__PURE__ */ jsx54(
          "button",
          {
  ...
  try {
    ...
    return {
      ...
      renderValue: (value, editor2, from) => {
        ...
        return React8.createElement(DecoratorComponent, __spreadValues({
...
var InlineDecoratorPluginKey = new PluginKey5("inlineDecorator");
var InlineDecoratorSuggestionPluginKey = new PluginKey5(
...
var InlineDecoratorExtension = Extension2.create({
  ...
  addProseMirrorPlugins() {
    return [
      // Suggestion plugin
      Suggestion2(__spreadProps(__spreadValues({
        editor: this.editor
      }, this.options.suggestion), {
        pluginKey: InlineDecoratorSuggestionPluginKey
      })),
...
import { forwardRef as forwardRef10, useImperativeHandle as useImperativeHandle2, useRef as useRef11, useMemo as useMemo13 } from "react";
...
var InlineDecoratorList = forwardRef10(
  (props, ref) => {
    var _a;
    ...
    const transformedItems = useMemo13(
      () => transformItemsForPopover(items),
      [items]
    );
    const handleKeyDown = useMemo13(() => createKeyboardHandler(popoverRef), []);
    const handleItemSelect = useMemo13(
...
var Footer = Node10.create({
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "small",
      mergeAttributes9(this.options.HTMLAttributes, HTMLAttributes3, {
...
import { Repeat2 as Repeat23 } from "lucide-react";
...
function RepeatView(props) {
  ...
  return /* @__PURE__ */ jsxs33(
    NodeViewWrapper7,
    {
      ...
      className: "mly-relative",
      children: [
        /* @__PURE__ */ jsx56(NodeViewContent2, { className: "is-editable" }),
        /* @__PURE__ */ jsxs33(
          "div",
          {
            role: "button",
            ...
            children: [
              /* @__PURE__ */ jsx56(Repeat23, { className: "mly-size-3 mly-stroke-[2.5] mly-text-midnight-gray" }),
              /* @__PURE__ */ jsx56("div", { className: "mly-w-[1.5px] mly-grow mly-rounded-full mly-bg-rose-300" })
            ]
          }
        )
      ]
...
var RepeatExtension = Node11.create({
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes10(HTMLAttributes3, {
        "data-type": this.name
      }),
      0
    ];
...
import { useCallback as useCallback12, useState as useState11, useRef as useRef12, useEffect as useEffect8 } from "react";
...
function SlashCommandItem(props) {
  ...
  let value = /* @__PURE__ */ jsxs34(Fragment6, { children: [
    /* @__PURE__ */ jsx57("div", { className: "mly-flex mly-h-6 mly-w-6 mly-shrink-0 mly-items-center mly-justify-center", children: item.icon }),
    /* @__PURE__ */ jsxs34("div", { className: "mly-grow", children: [
      /* @__PURE__ */ jsx57("p", { className: "mly-font-medium", children: item.title }),
      /* @__PURE__ */ jsx57("p", { className: "mly-text-xs mly-text-gray-400", children: item.description })
    ] }),
    isSubCommand && /* @__PURE__ */ jsx57("span", { className: "mly-block mly-px-1 mly-text-gray-400", children: /* @__PURE__ */ jsx57(ChevronRightIcon, { className: "mly-size-3.5 mly-stroke-[2.5]" }) })
  ] });
  if (renderFunctionValue !== null && renderFunctionValue !== true) {
    value = renderFunctionValue;
  }
  const checkVisibility = useCallback12(() => {
  ...
  const openTimerRef = useRef12(0);
  const handleDelayedOpen = useCallback12(() => {
  ...
  return /* @__PURE__ */ jsxs34(Tooltip, { open, children: [
    ...
    /* @__PURE__ */ jsx57(
      TooltipContent,
      {
        ...
        children: typeof item.preview === "function" ? item == null ? void 0 : item.preview(editor) : /* @__PURE__ */ jsxs34(Fragment6, { children: [
          /* @__PURE__ */ jsx57("figure", { className: "mly-relative mly-aspect-[2.5] mly-w-full mly-overflow-hidden mly-rounded-md mly-border mly-border-gray-200", children: /* @__PURE__ */ jsx57(
            "img",
            {
          ...
          /* @__PURE__ */ jsx57("p", { className: "mly-mt-2 mly-px-0.5 mly-text-gray-500", children: item.description })
        ] })
      }
    )
  ] });
...
var CommandList = forwardRef11(function CommandList2(props, ref) {
  const { items: groups, command, editor, range, query } = props;
  const [selectedGroupIndex, setSelectedGroupIndex] = useState12(0);
  const [selectedCommandIndex, setSelectedCommandIndex] = useState12(0);
  const [hoveredItemKey, setHoveredItemKey] = useState12(null);
  const prevQuery = useRef13("");
  const prevSelectedGroupIndex = useRef13(0);
  const prevSelectedCommandIndex = useRef13(0);
  ...
  const commandListContainer = useRef13(null);
  const activeCommandRef = useRef13(null);
  useLayoutEffect2(() => {
  ...
  return groups.length > 0 ? /* @__PURE__ */ jsx58(TooltipProvider, { children: /* @__PURE__ */ jsxs35("div", { className: "mly-z-50 mly-w-72 mly-overflow-hidden mly-rounded-md mly-border mly-border-gray-200 mly-bg-white mly-shadow-md mly-transition-all", children: [
    /* @__PURE__ */ jsx58(
      "div",
      {
        id: "slash-command",
        ...
        children: groups.map((group, groupIndex) => /* @__PURE__ */ jsxs35(Fragment7, { children: [
          /* @__PURE__ */ jsxs35(
            "span",
            {
              className: cn(
              ...
              children: [
                group.title,
                /* @__PURE__ */ jsx58("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx58("span", { className: "mly-text-sm mly-text-gray-400", children: "/" }) })
              ]
            }
          ),
          /* @__PURE__ */ jsx58("div", { className: "mly-space-y-0.5 mly-p-1", children: group.commands.map((item, commandIndex) => {
            const itemKey = `${groupIndex}-${commandIndex}`;
    ...
    /* @__PURE__ */ jsxs35("div", { className: "mly-flex mly-justify-between mly-rounded-b-md mly-border-t mly-border-gray-100 mly-bg-white mly-p-1.5", children: [
      /* @__PURE__ */ jsxs35("div", { className: "mly-flex mly-items-center mly-gap-0.5", children: [
        /* @__PURE__ */ jsx58("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx58(ArrowUp, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) }),
        /* @__PURE__ */ jsx58("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx58(ArrowDown, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) }),
        /* @__PURE__ */ jsx58("span", { className: "mly-ml-1.5 mly-text-xs mly-font-normal mly-text-gray-500", children: "Navigate" })
      ] }),
      /* @__PURE__ */ jsx58("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx58(CornerDownLeft3, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) })
    ] })
  ] }) }) : null;
});
...
import { forwardRef as forwardRef12, useImperativeHandle as useImperativeHandle4, useRef as useRef14 } from "react";
import tippy4 from "tippy.js";
import { jsx as jsx59 } from "react/jsx-runtime";
var VariableList = forwardRef12((props, ref) => {
...
// src/editor/components/text-menu/text-bubble-content.tsx
import { Fragment as Fragment8, jsx as jsx60, jsxs as jsxs36 } from "react/jsx-runtime";
function TextBubbleContent(props) {
  ...
  return /* @__PURE__ */ jsxs36(Fragment8, { children: [
    items.map((item, index) => /* @__PURE__ */ jsx60(BubbleMenuButton, __spreadValues({}, item), index)),
    /* @__PURE__ */ jsx60(
      AlignmentSwitch,
      {
    ...
    !state.isListActive && showListMenu && /* @__PURE__ */ jsxs36(Fragment8, { children: [
      /* @__PURE__ */ jsx60(
        BubbleMenuButton,
        {
          icon: List2,
      ...
      ColorPicker,
      {
        ...
        children: /* @__PURE__ */ jsx60(
          BaseButton,
          {
            ...
            type: "button",
            className: "!mly-h-7 mly-w-7 mly-shrink-0 mly-p-0",
            children: /* @__PURE__ */ jsxs36("div", { className: "mly-flex mly-flex-col mly-items-center mly-justify-center mly-gap-[1px]", children: [
              /* @__PURE__ */ jsx60("span", { className: "mly-font-bolder mly-font-mono mly-text-xs mly-text-slate-700", children: "A" }),
              /* @__PURE__ */ jsx60(
                "div",
                {
...
function TurnIntoBlock(props) {
  ...
  return /* @__PURE__ */ jsxs37(Popover, { children: [
    /* @__PURE__ */ jsxs37(Tooltip, { children: [
      /* @__PURE__ */ jsx61(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxs37(
        PopoverTrigger,
        {
          className: cn(
          ...
          children: [
            /* @__PURE__ */ jsx61(ActiveIcon, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5]" }),
            /* @__PURE__ */ jsx61(ChevronDownIcon2, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5]" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsx61(TooltipContent, { sideOffset: 8, children: "Turn into" })
    ] }),
    /* @__PURE__ */ jsx61(
      PopoverContent,
      {
          ...
          if (isOption(option)) {
            return /* @__PURE__ */ jsxs37(
              BaseButton,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx61(option.icon, { className: "mly-size-[15px] mly-shrink-0" }),
                  option.label
                ]
              },
              option.id
...
function TextBubbleMenu(props) {
  ...
  return /* @__PURE__ */ jsx62(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      className: "mly-flex mly-gap-0.5 mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-p-0.5 mly-shadow-md",
      children: /* @__PURE__ */ jsxs38(TooltipProvider, { children: [
        /* @__PURE__ */ jsx62(TurnIntoBlock, { options: turnIntoBlockOptions }),
        /* @__PURE__ */ jsx62(Divider, { className: "mly-mx-0" }),
        /* @__PURE__ */ jsx62(TextBubbleContent, { editor })
      ] })
    })
  );
}
...
function VariableBubbleMenu(props) {
  ...
  return /* @__PURE__ */ jsx63(
    ...
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      ...
      children: /* @__PURE__ */ jsx63(TooltipProvider, { children: /* @__PURE__ */ jsx63(TextBubbleContent, { showListMenu: false, editor }) })
    })
  );
}
...
function Editor13(props) {
  ...
  const formattedContent = useMemo15(() => {
    if (contentJson) {
  ...
  const menuContainerRef = useRef15(null);
  ...
  return /* @__PURE__ */ jsx64(MailyProvider, { placeholderUrl, children: /* @__PURE__ */ jsxs39(
    "div",
    {
      className: cn(
      ...
      children: [
        hasMenuBar && /* @__PURE__ */ jsx64(EditorMenuBar, { config: props.config, editor }),
        /* @__PURE__ */ jsxs39(
          "div",
          {
            className: cn(
            ...
            children: [
              /* @__PURE__ */ jsx64(TextBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(ImageBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(SpacerBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(EditorContent, { editor }),
              /* @__PURE__ */ jsx64(SectionBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(ColumnsBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(ContentMenu, { editor }),
              /* @__PURE__ */ jsx64(VariableBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(
                RepeatBubbleMenu,
                {
                  editor,
              ...
              /* @__PURE__ */ jsx64(HTMLBubbleMenu, { editor, appendTo: menuContainerRef }),
              /* @__PURE__ */ jsx64(InlineImageBubbleMenu, { editor, appendTo: menuContainerRef })
            ]
          }
        )
      ]
