...
import { useMemo as useMemo14, useRef as useRef15 } from "react";
...
import { forwardRef as forwardRef6, useRef as useRef7, useState as useState7, useEffect as useEffect7 } from "react";
...
import { useCallback as useCallback8, useMemo as useMemo8, useRef as useRef9, useState as useState9 } from "react";
...
import { forwardRef as forwardRef10, useImperativeHandle as useImperativeHandle2, useRef as useRef11, useMemo as useMemo12 } from "react";
...
var InlineDecoratorList = forwardRef10(
  (props, ref) => {
    ...
    const transformedItems = useMemo12(
      () => transformItemsForPopover(items),
      [items]
    );
    const handleKeyDown = useMemo12(() => createKeyboardHandler(popoverRef), []);
    const handleItemSelect = useMemo12(
...
import { useCallback as useCallback10, useState as useState11, useRef as useRef12, useEffect as useEffect8 } from "react";
...
function SlashCommandItem(props) {
  ...
  const checkVisibility = useCallback10(() => {
