...
var useEvent = (handler) => {
  const handlerRef = (0, import_react4.useRef)(null);
...
function ImageView(props) {
  ...
  const [isPlaceholderImage, setIsPlaceholderImage] = (0, import_react5.useState)(false);
  ...
  const [resizingStyle, setResizingStyle] = (0, import_react5.useState)();
  const [isDraggingOver, setIsDraggingOver] = (0, import_react5.useState)(false);
  ...
  const dragCornerButton = (0, import_react5.useCallback)(
    (direction) => {
  ...
  const handleImageUpload = (0, import_react5.useCallback)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        !hasImageSrc && status === "idle" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          ImageStatusLabel,
          {
            status: "idle",
            minHeight: height,
        ...
        !hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ImageStatusLabel, { status: "loading", minHeight: height }),
        hasImageSrc && isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ImageStatusLabel, { status: "variable", minHeight: height }),
        hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ImageStatusLabel, { status: "loading", minHeight: height }),
        hasImageSrc && status === "error" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ImageStatusLabel, { status: "error", minHeight: height }),
        isDroppable && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "input",
          {
            type: "file",
            accept: "image/*",
        ...
        hasImageSrc && status === "loaded" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
          ...
          selected && editor.isEditable && !isPlaceholderImage && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
            [
...
function LogoView(props) {
  ...
  const [isPlaceholderImage, setIsPlaceholderImage] = (0, import_react9.useState)(false);
  const [isDraggingOver, setIsDraggingOver] = (0, import_react9.useState)(false);
  const { onImageUpload, allowedMimeTypes = [] } = useImageUploadOptions(editor);
  let {
    alignment = "center",
    src: logoSrc,
  ...
  const handleImageUpload = (0, import_react8.useCallback)(
    (file) => __async(null, null, function* () {
      if (!isDroppable) {
        return;
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        !hasImageSrc && status === "idle" && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          ImageStatusLabel,
          {
            status: "idle",
            minHeight: logoSize,
        ...
        !hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ImageStatusLabel, { status: "loading", minHeight: logoSize }),
        hasImageSrc && isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ImageStatusLabel, { status: "variable", minHeight: logoSize }),
        hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ImageStatusLabel, { status: "loading", minHeight: logoSize }),
        hasImageSrc && status === "error" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ImageStatusLabel, { status: "error", minHeight: logoSize }),
        isDroppable && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "input",
          {
            type: "file",
            accept: "image/*",
        ...
        hasImageSrc && status === "loaded" && !isSrcVariable && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "img",
          {
            src: logoSrc,
            alt: "Logo",
...
function AlignmentSwitch(props) {
  ...
  const alignments = {
    left: {
      icon: import_lucide_react2.AlignLeft,
      tooltip: "Align Left",
      onClick: () => {
    ...
    center: {
      icon: import_lucide_react2.AlignCenter,
    ...
    right: {
      icon: import_lucide_react2.AlignRight,
      tooltip: "Align Right",
      onClick: () => {
...
function ColorPicker(props) {
  ...
  const popoverButton = /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PopoverTrigger, { asChild: true, children: children || /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    BaseButton,
    {
      variant: "ghost",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    Popover,
    {
      ...
      children: [
        tooltip ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Tooltip, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TooltipTrigger, { asChild: true, children: popoverButton }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TooltipContent, { sideOffset: 8, children: tooltip })
        ] }) : popoverButton,
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          PopoverContent,
          {
            ...
            sideOffset: 8,
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "mly-min-w-[260px] mly-rounded-xl mly-border mly-border-gray-200 mly-bg-white mly-p-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              ...
              suggestedColors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "-mly-mx-4 mly-my-4 mly-h-px mly-bg-gray-200" }),
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { className: "mly-text-xs mly-text-gray-500", children: "Recently used" }),
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "mly-mt-2 mly-flex mly-flex-wrap mly-gap-0.5", children: suggestedColors.map((suggestedColor) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                  BaseButton,
                  {
                    variant: "ghost",
                    size: "sm",
...
var button = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_lucide_react5.MousePointer, { className: "mly-h-4 mly-w-4" }),
...
var linkCard = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_lucide_react5.ArrowUpRightSquare, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var htmlCodeBlock = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_lucide_react6.CodeXmlIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var image = {
  ...
  searchTerms: ["image"],
  icon: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_lucide_react7.ImageIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var columns = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_lucide_react8.ColumnsIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var section = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_lucide_react8.RectangleHorizontal, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var repeat = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_lucide_react8.Repeat2, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var spacer = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_lucide_react8.MoveVertical, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var divider = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_lucide_react8.Minus, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var bulletList = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_lucide_react9.List, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var orderedList = {
  ...
  searchTerms: ["ordered"],
  icon: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_lucide_react9.ListOrdered, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var text = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.Text, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var heading1 = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.Heading1, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var heading2 = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.Heading2, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var heading3 = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.Heading3, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var hardBreak = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.DivideIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var blockquote = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.TextQuote, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var footer = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.FootprintsIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var clearLine = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_lucide_react10.EraserIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("mask", { id: "path-4-inside-1_1046_19527", fill: "white", children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("rect", { x: "3", y: "4", width: "8", height: "3", rx: "0.5" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
          "rect",
          {
            x: "3",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("rect", { x: "3", y: "8", width: "2", height: "1", rx: "0.5", fill: "currentColor" })
      ]
    })
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("rect", { x: "3", y: "6.5", width: "2", height: "1", rx: "0.5", fill: "currentColor" }),
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          "path",
          {
            fillRule: "evenodd",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("rect", { x: "6", y: "6", width: "2", height: "1", rx: "0.5", fill: "currentColor" }),
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
          "path",
          {
            fillRule: "evenodd",
...
var headerLogoWithTextHorizontal = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(LogoWithTextHorizonIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var headerLogoWithTextVertical = {
  ...
  searchTerms: ["logo", "text"],
  icon: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(LogoWithTextVerticalIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
    editor.chain().deleteRange(range).insertContent([
      {
        type: "image",
...
var headerLogoWithCoverImage = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(LogoWithCoverImageIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var footerCopyrightText = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_lucide_react11.CopyrightIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var footerCommunityFeedbackCta = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_lucide_react11.RectangleHorizontalIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
    editor.chain().focus().deleteRange(range).insertContent([
      {
        type: "image",
...
var footerCompanySignature = {
  ...
  icon: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_lucide_react11.LayoutTemplateIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
    editor.chain().focus().deleteRange(range).insertContent([
      { type: "horizontalRule" },
      {
    ...
    commands: [
      {
        ...
        icon: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_lucide_react12.Heading1, { className: "mly-h-4 mly-w-4" }),
      ...
      },
      {
        ...
        searchTerms: ["footers"],
        icon: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_lucide_react12.FootprintsIcon, { className: "mly-h-4 mly-w-4" }),
        commands: [
          footerCopyrightText,
...
var MailyContext = (0, import_react16.createContext)({
  placeholderUrl: DEFAULT_PLACEHOLDER_URL,
  blocks: DEFAULT_SLASH_COMMANDS
});
function useMailyContext() {
  const values = (0, import_react16.useContext)(MailyContext);
  if (!values) {
...
var VariableSuggestionsPopover = (0, import_react17.forwardRef)((props, ref) => {
  ...
  const itemRefs = (0, import_react17.useRef)([]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "mly-z-50 mly-w-64 mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-shadow-md mly-transition-all", children: [
    /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "mly-flex mly-items-center mly-justify-between mly-gap-2 mly-border-b mly-border-gray-200 mly-bg-soft-gray/40 mly-px-1 mly-py-1.5 mly-text-gray-500", children: [
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "mly-text-xs mly-uppercase", children: "Variables" }),
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(VariableIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_lucide_react13.Braces, { className: "mly-size-3 mly-stroke-[2.5]" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "mly-flex mly-w-fit mly-min-w-full mly-flex-col mly-gap-0.5 mly-p-1", children: (items == null ? void 0 : items.length) ? items == null ? void 0 : items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_lucide_react13.Braces, { className: "mly-size-3 mly-stroke-[2.5] mly-text-rose-600" }),
              item.name
            ]
          },
          index
        )) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "mly-flex mly-h-7 mly-w-full mly-items-center mly-gap-2 mly-rounded-md mly-px-2 mly-py-1 mly-text-left mly-font-mono mly-text-[13px] mly-text-gray-900 hover:mly-bg-soft-gray", children: "No result" }) })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "mly-flex mly-items-center mly-justify-between mly-gap-2 mly-border-t mly-border-gray-200 mly-px-1 mly-py-1.5 mly-text-gray-500", children: [
      /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "mly-flex mly-items-center mly-gap-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(VariableIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_lucide_react13.ArrowDownIcon, { className: "mly-size-3 mly-stroke-[2.5]" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(VariableIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_lucide_react13.ArrowUpIcon, { className: "mly-size-3 mly-stroke-[2.5]" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "mly-text-xs mly-text-gray-500", children: "Navigate" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(VariableIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_lucide_react13.CornerDownLeftIcon, { className: "mly-size-3 mly-stroke-[2.5]" }) })
    ] })
  ] });
});
...
function VariableView(props) {
  ...
  const renderVariable = (0, import_react19.useMemo)(() => {
    var _a, _b;
    ...
    import_react18.NodeViewWrapper,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
        Popover,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(PopoverTrigger, { children: renderVariable({
            ...
            /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
              PopoverContent,
              {
                ...
                onOpenAutoFocus: (e) => e.preventDefault(),
                onCloseAutoFocus: (e) => e.preventDefault(),
                children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "mly-flex mly-items-stretch mly-text-midnight-gray", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("label", { className: "mly-relative", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "mly-inline-block mly-px-2 mly-text-xs mly-text-midnight-gray", children: "Variable" }),
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
                      "input",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Divider, { className: "mly-mx-1.5" }),
                  /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("label", { className: "mly-relative", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "mly-inline-block mly-px-2 mly-pl-1 mly-text-xs mly-text-midnight-gray", children: "Default" }),
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
                      "input",
                      __spreadProps(__spreadValues({}, AUTOCOMPLETE_PASSWORD_MANAGERS_OFF), {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "mly-absolute mly-inset-y-0 mly-right-1 mly-flex mly-items-center", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_lucide_react14.Pencil, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) })
                  ] })
                ] }) })
              }
            )
...
var DefaultRenderVariable = (props) => {
  ...
  if (from === "button-variable") {
    return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "mly-inline-grid mly-h-7 mly-max-w-xs mly-grid-cols-[12px_1fr] mly-items-center mly-gap-1.5 mly-rounded-md mly-border mly-border-[var(--button-var-border-color)] mly-px-2 mly-font-mono mly-text-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_lucide_react14.Braces, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5]" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "mly-min-w-0 mly-truncate mly-text-left", children: name })
    ] });
  }
  if (from === "bubble-variable") {
    return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_lucide_react14.Braces, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5] mly-text-rose-600" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "mly-min-w-0 mly-truncate mly-text-left", children: name })
        ]
      }
    );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_lucide_react14.Braces, { className: "mly-size-[var(--variable-icon-size)] mly-shrink-0 mly-stroke-[2.5] mly-text-rose-600" }),
        name,
        required && !fallback && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_lucide_react14.AlertTriangle, { className: "mly-size-[var(--variable-icon-size)] mly-shrink-0 mly-stroke-[2.5]" })
      ]
    }
  );
};
...
var VariableExtension = import_core11.Node.create({
  ...
  addNodeView() {
    return (0, import_react20.ReactNodeViewRenderer)(VariableView, {
...
function LinkInputPopover(props) {
  ...
  const {
    ...
    onValueChange,
    tooltip,
    icon: Icon = import_lucide_react15.Link,
    editor,
    isVariable
  } = props;
  const [isOpen, setIsOpen] = (0, import_react21.useState)(false);
  const [isEditing, setIsEditing] = (0, import_react21.useState)(!isVariable);
  const linkInputRef = (0, import_react21.useRef)(null);
  ...
  const popoverButton = /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
    BaseButton,
    {
      variant: "ghost",
      size: "sm",
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Icon, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5] mly-text-midnight-gray" })
    }
  ) });
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(
    Popover,
    {
      ...
      children: [
        tooltip ? /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(Tooltip, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(TooltipTrigger, { asChild: true, children: popoverButton }),
          ...
          PopoverContent,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
              "form",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "mly-isolate mly-flex mly-rounded-lg", children: [
                  !isEditing && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "mly-flex mly-h-8 mly-items-center mly-rounded-lg mly-border mly-border-gray-300 mly-bg-white mly-px-0.5", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
                    "button",
                    {
                      onClick: () => {
                        setIsEditing(true);
                  ...
                  isEditing && /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "mly-relative", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "mly-absolute mly-inset-y-0 mly-left-1.5 mly-z-10 mly-flex mly-items-center", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_lucide_react15.LinkIcon, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
                      InputAutocomplete,
                      {
                        editor,
...
function Select(props) {
  ...
  const selectId = `mly${(0, import_react23.useId)()}`;
  const content = /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: "mly-relative", children: [
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("label", { htmlFor: selectId, className: "mly-sr-only", children: label }),
    Icon && /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "mly-pointer-events-none mly-absolute mly-inset-y-0 mly-left-2 mly-z-20 mly-flex mly-items-center", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(Icon, { className: cn("mly-size-3", iconClassName) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
      "select",
      {
        ...
        children: options.map((option) => /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("option", { value: option.value, children: option.label }, option.value))
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: "mly-pointer-events-none mly-absolute mly-inset-y-0 mly-right-0 mly-z-10 mly-flex mly-h-full mly-w-7 mly-items-center mly-justify-center mly-text-gray-600 peer-disabled:mly-opacity-50", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(Tooltip, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(TooltipTrigger, { asChild: true, children: content }),
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(TooltipContent, { sideOffset: 8, children: tooltip })
  ] });
}
...
function ButtonLabelInput(props) {
  ...
  const linkInputRef = (0, import_react24.useRef)(null);
  const [isEditing, setIsEditing] = (0, import_react24.useState)(!isVariable);
  const { placeholderUrl = DEFAULT_PLACEHOLDER_URL } = useMailyContext();
  ...
  const autoCompleteOptions = (0, import_react24.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "mly-isolate mly-flex mly-rounded-lg", children: [
    !isEditing && /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
      "button",
      {
        onClick: () => {
          setIsEditing(true);
...
function ButtonView(props) {
  ...
  const opts = useVariableOptions(editor);
  const renderVariable = opts == null ? void 0 : opts.renderVariable;
  const sizes = (0, import_react26.useMemo)(
    () => ({
      small: {
        paddingX: 24,
        paddingY: 6
  ...
  const size = (0, import_react26.useMemo)(() => {
    var _a;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
    import_react25.NodeViewWrapper,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(Popover, { open: props.selected && editor.isEditable, children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
          "button",
          {
            className: cn(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
          PopoverContent,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "mly-flex mly-items-stretch mly-text-midnight-gray", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "mly-flex mly-space-x-0.5", children: [
                /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
                  Select,
                  {
                    label: "Border Radius",
...
function TextColorPickerPopup(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(ColorPicker, { color, onColorChange: onChange, tooltip: "Text Color", children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
    BaseButton,
    {
      variant: "ghost",
      size: "sm",
      type: "button",
      className: "mly-size-7",
      children: /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "mly-flex mly-flex-col mly-items-center mly-justify-center mly-gap-[1px]", children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("span", { className: "mly-font-bolder mly-font-mono mly-text-xs mly-text-midnight-gray", children: "A" }),
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
          "div",
          {
...
var ButtonExtension = import_core12.Node.create({
  ...
  addNodeView() {
    return (0, import_react27.ReactNodeViewRenderer)(ButtonView, {
...
function SlashCommandItem(props) {
  ...
  const checkVisibility = (0, import_react31.useCallback)(() => {
...
var CommandList = (0, import_react33.forwardRef)(function CommandList2(props, ref) {
  ...
  return groups.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "mly-z-50 mly-w-72 mly-overflow-hidden mly-rounded-md mly-border mly-border-gray-200 mly-bg-white mly-shadow-md mly-transition-all", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "mly-flex mly-justify-between mly-rounded-b-md mly-border-t mly-border-gray-100 mly-bg-white mly-p-1.5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: "mly-flex mly-items-center mly-gap-0.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_lucide_react19.ArrowUp, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_lucide_react19.ArrowDown, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("span", { className: "mly-ml-1.5 mly-text-xs mly-font-normal mly-text-gray-500", children: "Navigate" })
      ] }),
...
var InlineImageExtension = import_core16.Node.create({
  name: "inlineImage",
  inline: true,
  group: "inline",
  selectable: false,
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes2 }) {
    const attrs = (0, import_core16.mergeAttributes)(this.options.HTMLAttributes, HTMLAttributes2, {
      "data-type": this.name,
  ...
  addProseMirrorPlugins() {
    return [
      new import_state5.Plugin({
        key: new import_state5.PluginKey("inlineImage"),
        props: {
      ...
      "Mod-a": ({ editor }) => {
        ...
        if (from && to) {
          const transaction = editor.state.tr.setSelection(
            import_state6.TextSelection.between(from, to)
          );
