...
var DefaultInlineDecoratorComponent = ({ decoratorKey, onUpdate, onDelete }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { children: decoratorKey }),
        /* @__PURE__ */ jsx(
          "button",
          {
...
import { forwardRef, useRef, useState, useEffect as useEffect2 } from "react";
import { jsx as jsx2, jsxs as jsxs2 } from "react/jsx-runtime";
var SuggestionInput = forwardRef((props, ref) => {
  var _b;
  const _a = props, {
    value = "",
    onValueChange,
  ...
  return /* @__PURE__ */ jsxs2("div", { className: cn("mly-relative"), ref: containerRef, children: [
    /* @__PURE__ */ jsxs2("label", { className: "mly-relative", children: [
      ...
      /* @__PURE__ */ jsx2("div", { className: "mly-absolute mly-inset-y-0 mly-right-1 mly-flex mly-items-center", children: /* @__PURE__ */ jsx2(CornerDownLeft, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) })
    ] }),
    isTriggering && VariableSuggestionPopoverComponent && /* @__PURE__ */ jsx2("div", { className: "mly-absolute mly-left-0 mly-top-8", children: /* @__PURE__ */ jsx2(
    ...
    isLoading && /* @__PURE__ */ jsx2("div", { className: "mly-absolute mly-left-0 mly-top-8 mly-rounded-md mly-bg-white mly-p-2 mly-shadow-md", children: "Loading suggestions..." })
  ] });
});
  ...
  try {
    ...
    return {
      ...
      renderValue: (value, editor2, from) => {
        ...
        return React2.createElement(DecoratorComponent, __spreadValues({
...
var InlineDecoratorPluginKey = new PluginKey2("inlineDecorator");
var InlineDecoratorSuggestionPluginKey = new PluginKey2(
...
var InlineDecoratorExtension = Extension2.create({
  name: "inlineDecorator",
  addOptions() {
    return {
...
import { forwardRef as forwardRef2, useImperativeHandle, useRef as useRef2, useMemo as useMemo4 } from "react";
...
var InlineDecoratorList = forwardRef2(
  (props, ref) => {
    var _a;
    ...
    const transformedItems = useMemo4(
      () => transformItemsForPopover(items),
      [items]
    );
    const handleKeyDown = useMemo4(() => createKeyboardHandler(popoverRef), []);
    const handleItemSelect = useMemo4(
...
function createTippyPopupManager() {
  ...
  return {
    onStart: (props) => {
      component = new ReactRenderer2(InlineDecoratorList, {
        props,
        editor: props.editor
      });
      if (!props.clientRect) {
...
var Footer = Node.create({
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "small",
      mergeAttributes(this.options.HTMLAttributes, HTMLAttributes3, {
...
var SectionExtension = Node2.create({
  name: "section",
  group: "block",
    ...
    return [
      ...
      [
        ...
        [
          ...
          [
            "td",
            mergeAttributes2(HTMLAttributes3, {
...
import { mergeAttributes as mergeAttributes4, Node as Node4 } from "@tiptap/core";
...
function LinkCardComponent(props) {
  ...
  return /* @__PURE__ */ jsx7(
    NodeViewWrapper,
    {
      ...
      children: /* @__PURE__ */ jsxs3(Popover, { open: props.selected, children: [
        /* @__PURE__ */ jsx7(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx7(
          "div",
          {
            tabIndex: -1,
            onClick: (e) => {
            ...
            children: /* @__PURE__ */ jsxs3("div", { className: "mly-no-prose mly-flex mly-flex-col mly-rounded-lg mly-border mly-border-gray-300", children: [
              image2 && /* @__PURE__ */ jsx7("div", { className: "mly-relative mly-mb-1.5 mly-w-full mly-shrink-0", children: /* @__PURE__ */ jsx7(
                "img",
                {
                  src: image2,
                  alt: "link-card",
              ...
              /* @__PURE__ */ jsx7("div", { className: "mly-flex mly-items-stretch mly-p-3", children: /* @__PURE__ */ jsxs3("div", { className: cn("mly-flex mly-flex-col"), children: [
                /* @__PURE__ */ jsxs3("div", { className: "!mly-mb-1.5 mly-flex mly-items-center mly-gap-1.5", children: [
                  /* @__PURE__ */ jsx7("h2", { className: "!mly-mb-0 !mly-text-lg mly-font-semibold", children: title }),
                  badgeText && /* @__PURE__ */ jsx7("span", { className: "!mly-font-base text-xs mly-rounded-md mly-bg-yellow-200 mly-px-2 mly-py-1 mly-font-semibold mly-leading-none", children: badgeText }),
                  " ",
                  subTitle && !badgeText && /* @__PURE__ */ jsx7("span", { className: "!mly-font-base text-xs mly-font-regular mly-rounded-md mly-leading-none mly-text-gray-400", children: subTitle })
                ] }),
                /* @__PURE__ */ jsxs3("p", { className: "!mly-my-0 !mly-text-base mly-text-gray-500", children: [
                  description,
                  " ",
                  linkTitle ? /* @__PURE__ */ jsx7("a", { href: link, className: "mly-font-semibold", children: linkTitle }) : null
                ] })
              ] }) })
            ] })
          }
        ...
        /* @__PURE__ */ jsxs3(
          PopoverContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Image" }),
                /* @__PURE__ */ jsx7(
                  Input,
                  {
              ...
              /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Title" }),
                /* @__PURE__ */ jsx7(
                  Input,
                  {
              ...
              /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Description" }),
                /* @__PURE__ */ jsx7(
                  Textarea,
                  {
              ...
              /* @__PURE__ */ jsxs3("div", { className: "mly-grid mly-grid-cols-2 mly-gap-2", children: [
                /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Link Title" }),
                  /* @__PURE__ */ jsx7(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Link" }),
                  /* @__PURE__ */ jsx7(
                    Input,
                    {
              ...
              /* @__PURE__ */ jsxs3("div", { className: "mly-grid mly-grid-cols-2 mly-gap-2", children: [
                /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Badge Text" }),
                  /* @__PURE__ */ jsx7(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxs3("label", { className: "mly-w-full mly-space-y-1", children: [
                  /* @__PURE__ */ jsx7("span", { className: "mly-text-xs mly-font-normal mly-text-slate-400", children: "Sub Title" }),
                  /* @__PURE__ */ jsx7(
                    Input,
                    {
...
// src/editor/extensions/link-card.ts
var LinkCardExtension = Node4.create({
  name: "linkCard",
  group: "block",
  atom: true,
  draggable: true,
...
var ColumnExtension = Node5.create({
  name: "column",
  content: "block+",
  isolating: true,
  addAttributes() {
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes5(HTMLAttributes3, {
        "data-type": "column",
...
import { Node as Node7 } from "@tiptap/core";
import { v4 as uuid3 } from "uuid";
var DEFAULT_COLUMNS_GAP = 8;
var ColumnsExtension = Node7.create({
  name: "columns",
  group: "columns",
  content: "column+",
  defining: true,
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes6(HTMLAttributes3, {
        "data-type": "columns",
        class: "mly-relative"
      }),
      0
...
var BaseButton = React6.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsx8(Comp, __spreadValues({ className: classes, ref }, props));
  }
);
...
function BubbleMenuButton(item) {
  ...
  const content = /* @__PURE__ */ jsx10(
    ...
    __spreadProps(__spreadValues({
      ...
      children: item.icon ? /* @__PURE__ */ jsx10(
        item.icon,
        {
          className: cn(
...
function ImageView(props) {
  ...
  const [isPlaceholderImage, setIsPlaceholderImage] = useState2(false);
  const { onImageUpload, allowedMimeTypes = [] } = useImageUploadOptions(editor);
  const wrapperRef = useRef4(null);
  const imgRef = useRef4(null);
  const [resizingStyle, setResizingStyle] = useState2();
  const [isDraggingOver, setIsDraggingOver] = useState2(false);
  ...
  const dragCornerButton = useCallback3(
    (direction) => {
  ...
  const handleImageUpload = useCallback3(
  ...
  return /* @__PURE__ */ jsxs5(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        !hasImageSrc && status === "idle" && /* @__PURE__ */ jsx11(
          ImageStatusLabel,
          {
            status: "idle",
            minHeight: height,
        ...
        !hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ jsx11(ImageStatusLabel, { status: "loading", minHeight: height }),
        hasImageSrc && isSrcVariable && /* @__PURE__ */ jsx11(ImageStatusLabel, { status: "variable", minHeight: height }),
        hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ jsx11(ImageStatusLabel, { status: "loading", minHeight: height }),
        hasImageSrc && status === "error" && !isSrcVariable && /* @__PURE__ */ jsx11(ImageStatusLabel, { status: "error", minHeight: height }),
        isDroppable && /* @__PURE__ */ jsx11(
          "input",
          {
            type: "file",
            accept: "image/*",
        ...
        hasImageSrc && status === "loaded" && !isSrcVariable && /* @__PURE__ */ jsxs5(Fragment2, { children: [
          /* @__PURE__ */ jsx11(
            "img",
          ...
          selected && editor.isEditable && !isPlaceholderImage && /* @__PURE__ */ jsxs5(Fragment2, { children: [
            [
              { left: 0, top: 0, height: "100%", width: "1px" },
              { right: 0, top: 0, height: "100%", width: "1px" },
              { top: 0, left: 0, width: "100%", height: "1px" },
              { bottom: 0, left: 0, width: "100%", height: "1px" }
            ].map((style, i) => /* @__PURE__ */ jsx11(
              "div",
              {
                className: "mly-bg-rose-500",
...
function ImageStatusLabel(props) {
  ...
  return /* @__PURE__ */ jsxs5(
    ...
    __spreadProps(__spreadValues({}, rest), {
      ...
      children: [
        status === "idle" && !isDropZone && /* @__PURE__ */ jsxs5(Fragment2, { children: [
          /* @__PURE__ */ jsx11(ImageOffIcon, { className: "mly-size-4 mly-stroke-[2.5]" }),
          /* @__PURE__ */ jsx11("span", { children: "No image selected" })
        ] }),
        status === "idle" && isDropZone && /* @__PURE__ */ jsxs5(Fragment2, { children: [
          /* @__PURE__ */ jsx11(GrabIcon, { className: "mly-size-4 mly-stroke-[2.5]" }),
          /* @__PURE__ */ jsx11("span", { children: "Click or Drop image here" })
        ] }),
        status === "loading" && /* @__PURE__ */ jsxs5(Fragment2, { children: [
          /* @__PURE__ */ jsx11(Loader2, { className: "mly-size-4 mly-animate-spin mly-stroke-[2.5]" }),
          /* @__PURE__ */ jsx11("span", { children: "Loading image..." })
        ] }),
        status === "error" && /* @__PURE__ */ jsxs5(Fragment2, { children: [
          /* @__PURE__ */ jsx11(Ban, { className: "mly-size-4 mly-stroke-[2.5]" }),
          /* @__PURE__ */ jsx11("span", { children: "Error loading image" })
        ] }),
        status === "variable" && /* @__PURE__ */ jsxs5(Fragment2, { children: [
          /* @__PURE__ */ jsx11(BracesIcon, { className: "mly-size-4 mly-stroke-[2.5]" }),
          /* @__PURE__ */ jsx11("span", { children: "Variable Image URL" })
        ] })
      ]
    })
  );
...
function LogoView(props) {
  ...
  const [isPlaceholderImage, setIsPlaceholderImage] = useState3(false);
  const [isDraggingOver, setIsDraggingOver] = useState3(false);
  const { onImageUpload, allowedMimeTypes = [] } = useImageUploadOptions(editor);
  let {
    alignment = "center",
    src: logoSrc,
  ...
  return /* @__PURE__ */ jsxs6(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        !hasImageSrc && status === "idle" && /* @__PURE__ */ jsx12(
          ImageStatusLabel,
          {
            status: "idle",
            minHeight: logoSize,
        ...
        !hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ jsx12(ImageStatusLabel, { status: "loading", minHeight: logoSize }),
        hasImageSrc && isSrcVariable && /* @__PURE__ */ jsx12(ImageStatusLabel, { status: "variable", minHeight: logoSize }),
        hasImageSrc && status === "loading" && !isSrcVariable && /* @__PURE__ */ jsx12(ImageStatusLabel, { status: "loading", minHeight: logoSize }),
        hasImageSrc && status === "error" && !isSrcVariable && /* @__PURE__ */ jsx12(ImageStatusLabel, { status: "error", minHeight: logoSize }),
        isDroppable && /* @__PURE__ */ jsx12(
          "input",
          {
            type: "file",
            accept: "image/*",
        ...
        hasImageSrc && status === "loaded" && !isSrcVariable && /* @__PURE__ */ jsx12(
          "img",
          {
            src: logoSrc,
            alt: "Logo",
    ...
    /* @__PURE__ */ jsxs7(Tooltip, { children: [
      /* @__PURE__ */ jsx13(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx13(
        PopoverTrigger,
        {
          ...
          children: /* @__PURE__ */ jsx13(activeAlignment.icon, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5]" })
        }
      ) }),
      /* @__PURE__ */ jsx13(TooltipContent, { sideOffset: 8, children: "Alignment" })
    ] }),
    /* @__PURE__ */ jsx13(
      PopoverContent,
      {
...
import { memo, useMemo as useMemo5, useRef as useRef6, useState as useState4 } from "react";
...
import { CornerDownLeft as CornerDownLeft2 } from "lucide-react";
import { forwardRef as forwardRef8, useRef as useRef5 } from "react";
import { jsx as jsx14, jsxs as jsxs8 } from "react/jsx-runtime";
var InputAutocomplete = forwardRef8((props, ref) => {
  var _b;
  const _a = props, {
    value = "",
    onValueChange,
  ...
  return /* @__PURE__ */ jsxs8("div", { className: cn("mly-relative"), ref: containerRef, children: [
    /* @__PURE__ */ jsxs8("label", { className: "mly-relative", children: [
      /* @__PURE__ */ jsx14(
        "input",
        __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, AUTOCOMPLETE_PASSWORD_MANAGERS_OFF), {
      ...
      /* @__PURE__ */ jsx14("div", { className: "mly-absolute mly-inset-y-0 mly-right-1 mly-flex mly-items-center", children: /* @__PURE__ */ jsx14(CornerDownLeft2, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) })
    ] }),
    isTriggeringVariable && /* @__PURE__ */ jsx14("div", { className: "mly-absolute mly-left-0 mly-top-8", children: /* @__PURE__ */ jsx14(
      VariableSuggestionPopoverComponent,
      {
        ...
        /* @__PURE__ */ jsxs9(Tooltip, { children: [
          /* @__PURE__ */ jsx15(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx15(
            PopoverTrigger,
            {
              ...
              children: /* @__PURE__ */ jsx15(Eye, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5]" })
            }
          ) }),
          /* @__PURE__ */ jsx15(TooltipContent, { sideOffset: 8, children: "Show block conditionally" })
        ] }),
        /* @__PURE__ */ jsxs9(
          PopoverContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs9("div", { className: "mly-flex mly-items-center mly-gap-1.5 mly-px-1.5 mly-text-sm mly-leading-none", children: [
                "Show if",
                /* @__PURE__ */ jsxs9(Tooltip, { children: [
                  /* @__PURE__ */ jsx15(TooltipTrigger, { children: /* @__PURE__ */ jsx15(
                    InfoIcon,
                    {
...
function ColorPicker(props) {
  ...
  const popoverButton = /* @__PURE__ */ jsx16(PopoverTrigger, { asChild: true, children: children || /* @__PURE__ */ jsx16(
    BaseButton,
    {
      variant: "ghost",
  ...
  return /* @__PURE__ */ jsxs10(
    Popover,
    {
      ...
      children: [
        tooltip ? /* @__PURE__ */ jsxs10(Tooltip, { children: [
          /* @__PURE__ */ jsx16(TooltipTrigger, { asChild: true, children: popoverButton }),
          /* @__PURE__ */ jsx16(TooltipContent, { sideOffset: 8, children: tooltip })
        ] }) : popoverButton,
        /* @__PURE__ */ jsx16(
          PopoverContent,
          {
            ...
            sideOffset: 8,
            children: /* @__PURE__ */ jsxs10("div", { className: "mly-min-w-[260px] mly-rounded-xl mly-border mly-border-gray-200 mly-bg-white mly-p-4", children: [
              /* @__PURE__ */ jsx16(
                HexColorPicker,
                {
                  color,
              ...
              suggestedColors.length > 0 && /* @__PURE__ */ jsxs10("div", { children: [
                /* @__PURE__ */ jsx16("div", { className: "-mly-mx-4 mly-my-4 mly-h-px mly-bg-gray-200" }),
                /* @__PURE__ */ jsx16("h2", { className: "mly-text-xs mly-text-gray-500", children: "Recently used" }),
                /* @__PURE__ */ jsx16("div", { className: "mly-mt-2 mly-flex mly-flex-wrap mly-gap-0.5", children: suggestedColors.map((suggestedColor) => /* @__PURE__ */ jsx16(
                  BaseButton,
                  {
                    variant: "ghost",
                    size: "sm",
...
var button = {
  ...
  icon: /* @__PURE__ */ jsx18(MousePointer, { className: "mly-h-4 mly-w-4" }),
...
var linkCard = {
  ...
  icon: /* @__PURE__ */ jsx18(ArrowUpRightSquare, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var htmlCodeBlock = {
  ...
  icon: /* @__PURE__ */ jsx19(CodeXmlIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var image = {
  ...
  searchTerms: ["image"],
  icon: /* @__PURE__ */ jsx20(ImageIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var columns = {
  ...
  icon: /* @__PURE__ */ jsx21(ColumnsIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var section = {
  ...
  icon: /* @__PURE__ */ jsx21(RectangleHorizontal, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var repeat = {
  ...
  icon: /* @__PURE__ */ jsx21(Repeat2, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var spacer = {
  ...
  icon: /* @__PURE__ */ jsx21(MoveVertical, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var divider = {
  ...
  icon: /* @__PURE__ */ jsx21(Minus, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var bulletList = {
  ...
  icon: /* @__PURE__ */ jsx22(List, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var orderedList = {
  ...
  searchTerms: ["ordered"],
  icon: /* @__PURE__ */ jsx22(ListOrdered, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var text = {
  ...
  icon: /* @__PURE__ */ jsx23(Text, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var heading1 = {
  ...
  icon: /* @__PURE__ */ jsx23(Heading1, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var heading2 = {
  ...
  icon: /* @__PURE__ */ jsx23(Heading2, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var heading3 = {
  ...
  icon: /* @__PURE__ */ jsx23(Heading3, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var hardBreak = {
  ...
  icon: /* @__PURE__ */ jsx23(DivideIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var blockquote = {
  ...
  icon: /* @__PURE__ */ jsx23(TextQuote, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var footer = {
  ...
  icon: /* @__PURE__ */ jsx23(FootprintsIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var clearLine = {
  ...
  icon: /* @__PURE__ */ jsx23(EraserIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
  ...
  return /* @__PURE__ */ jsxs11(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ jsx24("mask", { id: "path-4-inside-1_1046_19527", fill: "white", children: /* @__PURE__ */ jsx24("rect", { x: "3", y: "4", width: "8", height: "3", rx: "0.5" }) }),
        /* @__PURE__ */ jsx24(
          "rect",
          {
            x: "3",
        ...
        /* @__PURE__ */ jsx24("rect", { x: "3", y: "8", width: "2", height: "1", rx: "0.5", fill: "currentColor" })
      ]
    })
  );
}
  ...
  return /* @__PURE__ */ jsxs12(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ jsx25("rect", { x: "3", y: "6.5", width: "2", height: "1", rx: "0.5", fill: "currentColor" }),
        /* @__PURE__ */ jsx25(
          "path",
          {
            fillRule: "evenodd",
  ...
  return /* @__PURE__ */ jsxs13(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ jsx26("rect", { x: "6", y: "6", width: "2", height: "1", rx: "0.5", fill: "currentColor" }),
        /* @__PURE__ */ jsx26(
          "path",
          {
            fillRule: "evenodd",
...
var headerLogoWithTextHorizontal = {
  ...
  icon: /* @__PURE__ */ jsx27(LogoWithTextHorizonIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var headerLogoWithTextVertical = {
  ...
  searchTerms: ["logo", "text"],
  icon: /* @__PURE__ */ jsx27(LogoWithTextVerticalIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
    editor.chain().deleteRange(range).insertContent([
      {
        type: "image",
...
var headerLogoWithCoverImage = {
  ...
  icon: /* @__PURE__ */ jsx27(LogoWithCoverImageIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var footerCopyrightText = {
  ...
  icon: /* @__PURE__ */ jsx28(CopyrightIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
...
var footerCommunityFeedbackCta = {
  ...
  icon: /* @__PURE__ */ jsx28(RectangleHorizontalIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
    editor.chain().focus().deleteRange(range).insertContent([
      {
        type: "image",
...
var footerCompanySignature = {
  ...
  icon: /* @__PURE__ */ jsx28(LayoutTemplateIcon, { className: "mly-h-4 mly-w-4" }),
  command: ({ editor, range }) => {
    editor.chain().focus().deleteRange(range).insertContent([
      { type: "horizontalRule" },
      {
    ...
    commands: [
      {
        ...
        icon: /* @__PURE__ */ jsx29(Heading12, { className: "mly-h-4 mly-w-4" }),
      ...
      },
      {
        ...
        searchTerms: ["footers"],
        icon: /* @__PURE__ */ jsx29(FootprintsIcon2, { className: "mly-h-4 mly-w-4" }),
        commands: [
          footerCopyrightText,
...
var VariableSuggestionsPopover = forwardRef9((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "mly-z-50 mly-w-64 mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-shadow-md mly-transition-all", children: [
    /* @__PURE__ */ jsxs14("div", { className: "mly-flex mly-items-center mly-justify-between mly-gap-2 mly-border-b mly-border-gray-200 mly-bg-soft-gray/40 mly-px-1 mly-py-1.5 mly-text-gray-500", children: [
      /* @__PURE__ */ jsx31("span", { className: "mly-text-xs mly-uppercase", children: "Variables" }),
      /* @__PURE__ */ jsx31(VariableIcon, { children: /* @__PURE__ */ jsx31(Braces, { className: "mly-size-3 mly-stroke-[2.5]" }) })
    ] }),
    /* @__PURE__ */ jsx31(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx31("div", { className: "mly-flex mly-w-fit mly-min-w-full mly-flex-col mly-gap-0.5 mly-p-1", children: (items == null ? void 0 : items.length) ? items == null ? void 0 : items.map((item, index) => /* @__PURE__ */ jsxs14(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx31(Braces, { className: "mly-size-3 mly-stroke-[2.5] mly-text-rose-600" }),
              item.name
            ]
          },
          index
        )) : /* @__PURE__ */ jsx31("div", { className: "mly-flex mly-h-7 mly-w-full mly-items-center mly-gap-2 mly-rounded-md mly-px-2 mly-py-1 mly-text-left mly-font-mono mly-text-[13px] mly-text-gray-900 hover:mly-bg-soft-gray", children: "No result" }) })
      }
    ),
    /* @__PURE__ */ jsxs14("div", { className: "mly-flex mly-items-center mly-justify-between mly-gap-2 mly-border-t mly-border-gray-200 mly-px-1 mly-py-1.5 mly-text-gray-500", children: [
      /* @__PURE__ */ jsxs14("div", { className: "mly-flex mly-items-center mly-gap-1", children: [
        /* @__PURE__ */ jsx31(VariableIcon, { children: /* @__PURE__ */ jsx31(ArrowDownIcon, { className: "mly-size-3 mly-stroke-[2.5]" }) }),
        /* @__PURE__ */ jsx31(VariableIcon, { children: /* @__PURE__ */ jsx31(ArrowUpIcon, { className: "mly-size-3 mly-stroke-[2.5]" }) }),
        /* @__PURE__ */ jsx31("span", { className: "mly-text-xs mly-text-gray-500", children: "Navigate" })
      ] }),
      /* @__PURE__ */ jsx31(VariableIcon, { children: /* @__PURE__ */ jsx31(CornerDownLeftIcon, { className: "mly-size-3 mly-stroke-[2.5]" }) })
    ] })
  ] });
});
    ...
    NodeViewWrapper4,
    {
      ...
      children: /* @__PURE__ */ jsxs15(
        Popover,
        {
          ...
          children: [
            /* @__PURE__ */ jsx32(PopoverTrigger, { children: renderVariable({
            ...
            /* @__PURE__ */ jsx32(
              PopoverContent,
              {
                ...
                onOpenAutoFocus: (e) => e.preventDefault(),
                onCloseAutoFocus: (e) => e.preventDefault(),
                children: /* @__PURE__ */ jsx32(TooltipProvider, { children: /* @__PURE__ */ jsxs15("div", { className: "mly-flex mly-items-stretch mly-text-midnight-gray", children: [
                  /* @__PURE__ */ jsxs15("label", { className: "mly-relative", children: [
                    /* @__PURE__ */ jsx32("span", { className: "mly-inline-block mly-px-2 mly-text-xs mly-text-midnight-gray", children: "Variable" }),
                    /* @__PURE__ */ jsx32(
                      "input",
                  ...
                  /* @__PURE__ */ jsx32(Divider, { className: "mly-mx-1.5" }),
                  /* @__PURE__ */ jsxs15("label", { className: "mly-relative", children: [
                    /* @__PURE__ */ jsx32("span", { className: "mly-inline-block mly-px-2 mly-pl-1 mly-text-xs mly-text-midnight-gray", children: "Default" }),
                    /* @__PURE__ */ jsx32(
                      "input",
                      __spreadProps(__spreadValues({}, AUTOCOMPLETE_PASSWORD_MANAGERS_OFF), {
                    ...
                    /* @__PURE__ */ jsx32("div", { className: "mly-absolute mly-inset-y-0 mly-right-1 mly-flex mly-items-center", children: /* @__PURE__ */ jsx32(Pencil, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) })
                  ] })
                ] }) })
              }
            )
...
var DefaultRenderVariable = (props) => {
  ...
  if (from === "button-variable") {
    return /* @__PURE__ */ jsxs15("div", { className: "mly-inline-grid mly-h-7 mly-max-w-xs mly-grid-cols-[12px_1fr] mly-items-center mly-gap-1.5 mly-rounded-md mly-border mly-border-[var(--button-var-border-color)] mly-px-2 mly-font-mono mly-text-sm", children: [
      /* @__PURE__ */ jsx32(Braces2, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5]" }),
      /* @__PURE__ */ jsx32("span", { className: "mly-min-w-0 mly-truncate mly-text-left", children: name })
    ] });
  }
  if (from === "bubble-variable") {
    return /* @__PURE__ */ jsxs15(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx32(Braces2, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5] mly-text-rose-600" }),
          /* @__PURE__ */ jsx32("span", { className: "mly-min-w-0 mly-truncate mly-text-left", children: name })
        ]
      }
    );
  ...
  return /* @__PURE__ */ jsxs15(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx32(Braces2, { className: "mly-size-[var(--variable-icon-size)] mly-shrink-0 mly-stroke-[2.5] mly-text-rose-600" }),
        name,
        required && !fallback && /* @__PURE__ */ jsx32(AlertTriangle, { className: "mly-size-[var(--variable-icon-size)] mly-shrink-0 mly-stroke-[2.5]" })
      ]
    }
  );
};
...
var VariableExtension = Node8.create({
  name: "variable",
  group: "inline",
  inline: true,
  selectable: true,
  ...
  renderHTML({ node, HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes7({ "data-type": this.name }, HTMLAttributes3),
...
function LinkInputPopover(props) {
  ...
  const linkInputRef = useRef8(null);
  ...
  const popoverButton = /* @__PURE__ */ jsx33(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx33(
    BaseButton,
    {
      variant: "ghost",
      size: "sm",
      ...
      children: /* @__PURE__ */ jsx33(Icon, { className: "mly-h-3 mly-w-3 mly-shrink-0 mly-stroke-[2.5] mly-text-midnight-gray" })
    }
  ) });
    ...
    Popover,
    {
      ...
      children: [
        tooltip ? /* @__PURE__ */ jsxs16(Tooltip, { children: [
          /* @__PURE__ */ jsx33(TooltipTrigger, { asChild: true, children: popoverButton }),
          /* @__PURE__ */ jsx33(TooltipContent, { sideOffset: 8, children: tooltip })
        ] }) : popoverButton,
        /* @__PURE__ */ jsx33(
          PopoverContent,
          {
            ...
            children: /* @__PURE__ */ jsx33(
              "form",
              {
                ...
                children: /* @__PURE__ */ jsxs16("div", { className: "mly-isolate mly-flex mly-rounded-lg", children: [
                  !isEditing && /* @__PURE__ */ jsx33("div", { className: "mly-flex mly-h-8 mly-items-center mly-rounded-lg mly-border mly-border-gray-300 mly-bg-white mly-px-0.5", children: /* @__PURE__ */ jsx33(
                    "button",
                    {
                      onClick: () => {
                        setIsEditing(true);
                  ...
                  isEditing && /* @__PURE__ */ jsxs16("div", { className: "mly-relative", children: [
                    /* @__PURE__ */ jsx33("div", { className: "mly-absolute mly-inset-y-0 mly-left-1.5 mly-z-10 mly-flex mly-items-center", children: /* @__PURE__ */ jsx33(LinkIcon, { className: "mly-h-3 mly-w-3 mly-stroke-[2.5] mly-text-midnight-gray" }) }),
                    /* @__PURE__ */ jsx33(
                      InputAutocomplete,
                      {
                        editor,
...
function Select(props) {
  ...
  const content = /* @__PURE__ */ jsxs17("div", { className: "mly-relative", children: [
    /* @__PURE__ */ jsx34("label", { htmlFor: selectId, className: "mly-sr-only", children: label }),
    Icon && /* @__PURE__ */ jsx34("div", { className: "mly-pointer-events-none mly-absolute mly-inset-y-0 mly-left-2 mly-z-20 mly-flex mly-items-center", children: /* @__PURE__ */ jsx34(Icon, { className: cn("mly-size-3", iconClassName) }) }),
    /* @__PURE__ */ jsx34(
      "select",
      {
        id: selectId,
        ...
        children: options.map((option) => /* @__PURE__ */ jsx34("option", { value: option.value, children: option.label }, option.value))
      }
    ),
    /* @__PURE__ */ jsx34("span", { className: "mly-pointer-events-none mly-absolute mly-inset-y-0 mly-right-0 mly-z-10 mly-flex mly-h-full mly-w-7 mly-items-center mly-justify-center mly-text-gray-600 peer-disabled:mly-opacity-50", children: /* @__PURE__ */ jsx34(
      ChevronDownIcon,
      {
        size: 16,
        strokeWidth: 2,
  ...
  return /* @__PURE__ */ jsxs17(Tooltip, { children: [
    /* @__PURE__ */ jsx34(TooltipTrigger, { asChild: true, children: content }),
...
function ButtonLabelInput(props) {
  ...
  return /* @__PURE__ */ jsxs18("div", { className: "mly-isolate mly-flex mly-rounded-lg", children: [
    !isEditing && matchingProvider && /* @__PURE__ */ jsx35(
      "button",
      {
        onClick: () => {
          setIsEditing(true);
...
function ButtonView(props) {
  ...
  return /* @__PURE__ */ jsx36(
    NodeViewWrapper5,
    {
      ...
      children: /* @__PURE__ */ jsxs19(Popover, { open: props.selected && editor.isEditable, children: [
        /* @__PURE__ */ jsx36(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx36("div", { children: /* @__PURE__ */ jsx36(
          "button",
          {
            className: cn(
        ...
        /* @__PURE__ */ jsx36(
          PopoverContent,
          {
            ...
            onOpenAutoFocus: (e) => e.preventDefault(),
            onCloseAutoFocus: (e) => e.preventDefault(),
            children: /* @__PURE__ */ jsx36(TooltipProvider, { children: /* @__PURE__ */ jsxs19("div", { className: "mly-flex mly-items-stretch mly-text-midnight-gray", children: [
              /* @__PURE__ */ jsx36(
                ButtonLabelInput,
                {
                  value: text2,
...
function TextColorPickerPopup(props) {
  ...
  return /* @__PURE__ */ jsx36(ColorPicker, { color, onColorChange: onChange, tooltip: "Text Color", children: /* @__PURE__ */ jsx36(
    BaseButton,
    {
      variant: "ghost",
      size: "sm",
      type: "button",
      className: "mly-size-7",
      children: /* @__PURE__ */ jsxs19("div", { className: "mly-flex mly-flex-col mly-items-center mly-justify-center mly-gap-[1px]", children: [
        /* @__PURE__ */ jsx36("span", { className: "mly-font-bolder mly-font-mono mly-text-xs mly-text-midnight-gray", children: "A" }),
        /* @__PURE__ */ jsx36(
          "div",
          {
...
var ButtonExtension = Node9.create({
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes8(HTMLAttributes3, {
        "data-type": this.name
      })
    ];
  },
...
function RepeatView(props) {
  ...
  return /* @__PURE__ */ jsxs20(
    NodeViewWrapper6,
    {
      ...
      className: "mly-relative",
      children: [
        /* @__PURE__ */ jsx37(NodeViewContent, { className: "is-editable" }),
        /* @__PURE__ */ jsxs20(
          "div",
          {
            role: "button",
            ...
            children: [
              /* @__PURE__ */ jsx37(Repeat22, { className: "mly-size-3 mly-stroke-[2.5] mly-text-midnight-gray" }),
              /* @__PURE__ */ jsx37("div", { className: "mly-w-[1.5px] mly-grow mly-rounded-full mly-bg-rose-300" })
            ]
          }
        )
      ]
...
// src/editor/nodes/repeat/repeat.ts
var RepeatExtension = Node10.create({
  name: "repeat",
  group: "block",
  content: "(block|columns)+",
  draggable: true,
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    return [
      "div",
      mergeAttributes9(HTMLAttributes3, {
        "data-type": this.name
      }),
      0
    ];
...
// src/editor/extensions/maily-kit.tsx
var MailyKit = Extension3.create({
  name: "maily-kit",
  addOptions() {
    return {
      link: {
...
var SlashCommandExtension = Extension4.create({
  name: "slash-command",
  addOptions() {
    return {
      suggestion: {
...
import { useCallback as useCallback5, useState as useState8, useRef as useRef10, useEffect as useEffect6 } from "react";
...
function SlashCommandItem(props) {
  ...
  let value = /* @__PURE__ */ jsxs21(Fragment3, { children: [
    /* @__PURE__ */ jsx38("div", { className: "mly-flex mly-h-6 mly-w-6 mly-shrink-0 mly-items-center mly-justify-center", children: item.icon }),
    /* @__PURE__ */ jsxs21("div", { className: "mly-grow", children: [
      /* @__PURE__ */ jsx38("p", { className: "mly-font-medium", children: item.title }),
      /* @__PURE__ */ jsx38("p", { className: "mly-text-xs mly-text-gray-400", children: item.description })
    ] }),
    isSubCommand && /* @__PURE__ */ jsx38("span", { className: "mly-block mly-px-1 mly-text-gray-400", children: /* @__PURE__ */ jsx38(ChevronRightIcon, { className: "mly-size-3.5 mly-stroke-[2.5]" }) })
  ] });
  if (renderFunctionValue !== null && renderFunctionValue !== true) {
    value = renderFunctionValue;
  }
  const checkVisibility = useCallback5(() => {
  ...
  return /* @__PURE__ */ jsxs21(Tooltip, { open, children: [
    ...
    /* @__PURE__ */ jsx38(
      TooltipContent,
      {
        ...
        children: typeof item.preview === "function" ? item == null ? void 0 : item.preview(editor) : /* @__PURE__ */ jsxs21(Fragment3, { children: [
          /* @__PURE__ */ jsx38("figure", { className: "mly-relative mly-aspect-[2.5] mly-w-full mly-overflow-hidden mly-rounded-md mly-border mly-border-gray-200", children: /* @__PURE__ */ jsx38(
            "img",
            {
          ...
          /* @__PURE__ */ jsx38("p", { className: "mly-mt-2 mly-px-0.5 mly-text-gray-500", children: item.description })
        ] })
      }
    )
  ] });
...
// src/editor/extensions/slash-command/slash-command-view.tsx
import { ArrowUp, ArrowDown, CornerDownLeft as CornerDownLeft3 } from "lucide-react";
import { jsx as jsx39, jsxs as jsxs22 } from "react/jsx-runtime";
var CommandList = forwardRef10(function CommandList2(props, ref) {
  const { items: groups, command, editor, range, query } = props;
  const [selectedGroupIndex, setSelectedGroupIndex] = useState9(0);
  const [selectedCommandIndex, setSelectedCommandIndex] = useState9(0);
  const [hoveredItemKey, setHoveredItemKey] = useState9(null);
  ...
  return groups.length > 0 ? /* @__PURE__ */ jsx39(TooltipProvider, { children: /* @__PURE__ */ jsxs22("div", { className: "mly-z-50 mly-w-72 mly-overflow-hidden mly-rounded-md mly-border mly-border-gray-200 mly-bg-white mly-shadow-md mly-transition-all", children: [
    /* @__PURE__ */ jsx39(
      "div",
      {
        id: "slash-command",
        ...
        children: groups.map((group, groupIndex) => /* @__PURE__ */ jsxs22(Fragment4, { children: [
          /* @__PURE__ */ jsxs22(
            "span",
            {
              className: cn(
              ...
              children: [
                group.title,
                /* @__PURE__ */ jsx39("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx39("span", { className: "mly-text-sm mly-text-gray-400", children: "/" }) })
              ]
            }
          ),
          /* @__PURE__ */ jsx39("div", { className: "mly-space-y-0.5 mly-p-1", children: group.commands.map((item, commandIndex) => {
            const itemKey = `${groupIndex}-${commandIndex}`;
    ...
    /* @__PURE__ */ jsxs22("div", { className: "mly-flex mly-justify-between mly-rounded-b-md mly-border-t mly-border-gray-100 mly-bg-white mly-p-1.5", children: [
      /* @__PURE__ */ jsxs22("div", { className: "mly-flex mly-items-center mly-gap-0.5", children: [
        /* @__PURE__ */ jsx39("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx39(ArrowUp, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) }),
        /* @__PURE__ */ jsx39("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx39(ArrowDown, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) }),
        /* @__PURE__ */ jsx39("span", { className: "mly-ml-1.5 mly-text-xs mly-font-normal mly-text-gray-500", children: "Navigate" })
      ] }),
      /* @__PURE__ */ jsx39("div", { className: "mly-pointer-events-none mly-flex mly-h-5 mly-w-5 mly-items-center mly-justify-center mly-rounded-[6px] mly-border mly-border-gray-200 mly-bg-white mly-shadow-[0px_0px_0px_1px_rgba(14,18,27,0.02)_inset,_0px_1px_4px_0px_rgba(14,18,27,0.12)]", children: /* @__PURE__ */ jsx39(CornerDownLeft3, { className: "mly-h-3 mly-w-3 mly-text-gray-400" }) })
    ] })
  ] }) }) : null;
});
function getSlashCommandSuggestions(groups = DEFAULT_SLASH_COMMANDS) {
  return {
    ...
    render: () => {
      ...
      return {
        onStart: (props) => {
          component = new ReactRenderer3(CommandList, {
            props,
            editor: props.editor
          });
          popup = tippy2("body", {
...
var InlineImageExtension = Node11.create({
  name: "inlineImage",
  inline: true,
  group: "inline",
  selectable: false,
  ...
  renderHTML({ HTMLAttributes: HTMLAttributes3 }) {
    const attrs = mergeAttributes10(this.options.HTMLAttributes, HTMLAttributes3, {
      "data-type": this.name,
...
import { ReactRenderer as ReactRenderer4 } from "@tiptap/react";
import { forwardRef as forwardRef11, useImperativeHandle as useImperativeHandle4, useRef as useRef12 } from "react";
import tippy3 from "tippy.js";
import { jsx as jsx40 } from "react/jsx-runtime";
var VariableList = forwardRef11((props, ref) => {
  var _a;
...
function getVariableSuggestions(char = DEFAULT_VARIABLE_TRIGGER_CHAR) {
  return {
    ...
    render: () => {
      ...
      return {
        onStart: (props) => {
          component = new ReactRenderer4(VariableList, {
            props,
            editor: props.editor
          });
          if (!props.clientRect) {
...
function HTMLCodeBlockView(props) {
  ...
  return /* @__PURE__ */ jsxs23(
    NodeViewWrapper7,
    {
      ...
      children: [
        activeTab === "code" && /* @__PURE__ */ jsx41("pre", { className: "mly-my-0 mly-rounded-lg mly-border mly-border-gray-200 mly-bg-white mly-p-2 mly-text-black", children: /* @__PURE__ */ jsx41(
          NodeViewContent2,
          {
            as: "code",
        ...
        activeTab === "preview" && /* @__PURE__ */ jsx41(
          "div",
          {
            className: cn(
