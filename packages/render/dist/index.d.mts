...
declare const DEFAULT_SECTION_BORDER_STYLE = "solid";
...
declare class Maily {
    ...
    private isValidUrl;
    render({ noHtmlWrappingTags, ...options }?: RenderOptions): Promise<string>;
    /**
     * `markup` will render the JSON content into React Email markup.
     * and return the raw React Tree.
     */
    markup({ noHtmlWrappingTags }: Pick<RenderOptions, 'noHtmlWrappingTags'>): react_jsx_runtime.JSX.Element;
